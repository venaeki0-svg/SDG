...
export const MOCK_SOPS: SOP[] = [
    { id: 'SOP001', title: 'SOP Fotografi Acara Pernikahan', category: 'Fotografi', content: `# SOP Fotografi Acara Pernikahan... (Content unchanged)`, lastUpdated: createMockDate(-5, 1) },
    { id: 'SOP002', title: 'SOP Editing Tone Warna Cinematic', category: 'Editing', content: `# SOP Editing Tone Warna Cinematic... (Content unchanged)`, lastUpdated: createMockDate(-10, 1) },
    { id: 'SOP003', title: 'Prosedur Follow Up Klien', category: 'Layanan Klien', content: `# Prosedur Follow Up Klien\n\n1.  **Follow Up Awal (H+2):** Kirim pesan terima kasih setelah diskusi awal.\n2.  **Follow Up Kedua (H+7):** Tanyakan apakah ada pertanyaan lebih lanjut mengenai penawaran.\n3.  **Follow Up Terakhir (H+14):** Berikan informasi promo atau penawaran khusus jika ada.`, lastUpdated: createMockDate(-2, 5) },
];

export const MOCK_PACKAGES: Package[] = [
    { id: 'PKG001', name: 'Paket Ruby', price: 12000000, photographers: '2 Fotografer', videographers: '1 Videografer', physicalItems: [{ name: '1 Album (20x30 cm, 20 halaman)', price: 800000 }], digitalItems: ['300 Foto Edit', 'Video Teaser 1 Menit', 'Semua File (Link Drive)'], processingTime: '30 hari kerja', defaultPrintingCost: 800000, defaultTransportCost: 500000 },
    { id: 'PKG002', name: 'Paket Sapphire', price: 18500000, photographers: '2 Fotografer', videographers: '2 Videografer', physicalItems: [{ name: '1 Album (20x30 cm, 20 halaman, Box)', price: 1200000 }, { name: 'Cetak 4R (20 lembar + Box)', price: 300000 }], digitalItems: ['400 Foto Edit', 'Video Teaser 1 Menit', '3 Menit Cinematic Clip', 'Semua File (USB)'], processingTime: '45 hari kerja', defaultPrintingCost: 1500000, defaultTransportCost: 750000 },
    { id: 'PKG003', name: 'Paket Emerald', price: 28000000, photographers: '3 Fotografer', videographers: '2 Videografer', physicalItems: [{ name: '1 Album Magazine (30x30 cm, 40 halaman, Box)', price: 2500000 }, { name: 'Cetak 40x60 cm (1 lembar)', price: 750000 }, { name: 'Cetak 4R (40 lembar + Box)', price: 500000 }], digitalItems: ['500 Foto Edit', 'Video Teaser 1 Menit', '5 Menit Cinematic Clip', 'Semua File (USB)'], processingTime: '60 hari kerja', defaultPrintingCost: 3750000, defaultTransportCost: 1000000 },
    { id: 'PKG004', name: 'Paket Engagement Simple', price: 5000000, photographers: '1 Fotografer', videographers: '1 Videografer', physicalItems: [], digitalItems: ['200 Foto Edit', 'Video Teaser 1 Menit', 'Semua File (Link Drive)'], processingTime: '21 hari kerja', defaultPrintingCost: 0, defaultTransportCost: 400000 },
    { id: 'PKG005', name: 'Paket Prewedding Classic', price: 7500000, photographers: '2 Fotografer', videographers: '1 Videografer', physicalItems: [{ name: 'Cetak 40x60 cm (2 lembar)', price: 1500000 }], digitalItems: ['150 Foto Edit', 'Video Prewedding 1 Menit', 'Semua File (Link Drive)'], processingTime: '21 hari kerja', defaultPrintingCost: 1500000, defaultTransportCost: 1000000 }
];
...
export const MOCK_PROMO_CODES: PromoCode[] = [
    ...
    { id: 'PROMO002', code: 'DISKON500K', discountType: 'fixed', discountValue: 500000, isActive: true, usageCount: 1, maxUsage: null, expiryDate: null, createdAt: createMockDate(-2, 1) },
...
export const MOCK_CLIENTS: Client[] = [
  ...
  { id: 'CLI002', name: 'Budi Santoso (WO)', email: 'budi.s@email.com', phone: '082222222222', since: createMockDate(-3, 20), instagram: '@budisan', status: ClientStatus.INACTIVE, clientType: ClientType.VENDOR, lastContact: createMockDate(0, -40), portalAccessId: 'f3b9c1d8-6e5a-4b2a-9c8d-1e7a6b5c4d3e' },
  { id: 'CLI003', name: 'Citra Lestari', email: 'citra.l@email.com', phone: '083333333333', since: createMockDate(-2, 5), instagram: '@citralestari', status: ClientStatus.ACTIVE, clientType: ClientType.DIRECT, lastContact: createMockDate(0, -10), portalAccessId: 'b9e8c7d6-3a2b-4c1d-8e7f-6a5b4c3d2e1f' },
  ...
  { id: 'CLI006', name: 'Gita Permata', email: 'gita.p@email.com', phone: '086666666666', since: createMockDate(-1, 28), instagram: '@gitapermata', status: ClientStatus.ACTIVE, clientType: ClientType.DIRECT, lastContact: createMockDate(0, -18), portalAccessId: 'e9f0a1b2-c3d4-4e5f-8a9b-0c1d2e3f4a5b' },
  { id: 'CLI007', name: 'Hendra Wijaya (EO)', email: 'hendra.w@email.com', phone: '087777777777', since: createMockDate(-4, 10), instagram: '@hendraeo', status: ClientStatus.ACTIVE, clientType: ClientType.VENDOR, lastContact: createMockDate(0, -3), portalAccessId: 'f0a1b2c3-d4e5-4f6a-8b9c-0d1e2f3a4b5c' },
  { id: 'CLI008', name: 'Indah Sari', email: 'indah.s@email.com', phone: '088888888888', since: createMockDate(-5, 1), instagram: '@indahsari', status: ClientStatus.LOST, clientType: ClientType.DIRECT, lastContact: createMockDate(-4, 1), portalAccessId: 'a1b2c3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d' },
];
...
export const MOCK_LEADS: Lead[] = [
  ...
  { id: 'LEAD002', name: 'Gita Permata', contactChannel: ContactChannel.WHATSAPP, location: 'Bandung', status: LeadStatus.CONVERTED, date: createMockDate(0, -25), notes: 'Converted to client CLI006' },
  { id: 'LEAD003', name: 'Hendra Wijaya', contactChannel: ContactChannel.REFERRAL, location: 'Surabaya', status: LeadStatus.CONVERTED, date: createMockDate(0, -18), notes: 'Converted to client CLI007' },
  ...
  { id: 'LEAD005', name: 'Joko Anwar', contactChannel: ContactChannel.WHATSAPP, location: 'Yogyakarta', status: LeadStatus.DISCUSSION, date: createMockDate(0, -3) },
  { id: 'LEAD006', name: 'Kartika Dewi', contactChannel: ContactChannel.INSTAGRAM, location: 'Semarang', status: LeadStatus.FOLLOW_UP, date: createMockDate(0, -10) },
  { id: 'LEAD007', name: 'Lia Aminah', contactChannel: ContactChannel.WEBSITE, location: 'Jakarta', status: LeadStatus.DISCUSSION, date: createMockDate(0, -1) },
  { id: 'LEAD008', name: 'Maya Putri', contactChannel: ContactChannel.REFERRAL, location: 'Bandung', status: LeadStatus.DISCUSSION, date: createMockDate(0, 0) },
];

let teamMembersData: TeamMember[] = [
  { id: 'TM001', name: 'Bambang Sudiro', role: 'Fotografer', email: 'bambang@photographer.com', phone: '081211112222', standardFee: 1500000, noRek: 'BCA 1234567890', rewardBalance: 0, rating: 5, performanceNotes: [{ id: 'PN001', date: createMockDate(-1, 15), type: PerformanceNoteType.PRAISE, note: 'Komunikasi sangat baik dengan klien di proyek Andi & Siska.' }], portalAccessId: 'a1b2c3d4-freelancer-bambang'},
  { id: 'TM002', name: 'Siti Aminah', role: 'Fotografer', email: 'siti@photographer.com', phone: '081233334444', standardFee: 1500000, noRek: 'Mandiri 0987654321', rewardBalance: 0, rating: 4.5, performanceNotes: [], portalAccessId: 'a1b2c3d4-freelancer-siti' },
  { id: 'TM003', name: 'Rahmat Hidayat', role: 'Videografer', email: 'rahmat@videographer.com', phone: '081255556666', standardFee: 2000000, noRek: 'BRI 1122334455', rewardBalance: 0, rating: 4, performanceNotes: [{ id: 'PN003', date: createMockDate(-2, 20), type: PerformanceNoteType.LATE_DEADLINE, note: 'Terlambat 2 hari dalam pengiriman file mentah untuk proyek Budi.' }], portalAccessId: 'a1b2c3d4-freelancer-rahmat' },
...
let projectsData: Project[] = [
    { id: 'PRJ001', projectName: 'Pernikahan Andi & Siska', clientName: 'Andi & Siska', clientId: 'CLI001', projectType: 'Pernikahan', packageName: MOCK_PACKAGES[1].name, packageId: 'PKG002', addOns: [MOCK_ADDONS[1]], date: createMockDate(1, 10), deadlineDate: createMockDate(2, 25), location: 'Hotel Mulia, Jakarta', progress: 25, status: 'Persiapan', activeSubStatuses: ['Briefing Tim'], totalCost: 20500000, amountPaid: 0, paymentStatus: PaymentStatus.BELUM_BAYAR, team: [{ memberId: 'TM001', name: 'Bambang Sudiro', role: 'Fotografer', fee: 1500000, reward: 200000 }, { memberId: 'TM002', name: 'Siti Aminah', role: 'Fotografer', fee: 1500000, reward: 200000 }, { memberId: 'TM003', name: 'Rahmat Hidayat', role: 'Videografer', fee: 2000000, reward: 250000 }, { memberId: 'TM005', name: 'Agung Perkasa', role: 'Videografer', fee: 2000000, reward: 250000 }, { memberId: 'TM004', name: 'Dewi Anjani', role: 'Editor', fee: 1000000, reward: 100000 }], dpProofUrl: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=' },
    { id: 'PRJ002', projectName: 'Prewedding Budi & Rekan', clientName: 'Budi Santoso (WO)', clientId: 'CLI002', projectType: 'Pre-wedding', packageName: MOCK_PACKAGES[0].name, packageId: 'PKG001', addOns: [], date: createMockDate(-3, 25), deadlineDate: createMockDate(-2, 25), location: 'Bromo, Jawa Timur', progress: 100, status: 'Selesai', totalCost: 12000000, amountPaid: 0, paymentStatus: PaymentStatus.BELUM_BAYAR, team: [{ memberId: 'TM002', name: 'Siti Aminah', role: 'Fotografer', fee: 2000000, reward: 250000, subJob: 'Candid Photography' }], finalDriveLink: 'https://example.com/final-budi', isEditingConfirmedByClient: true, isPrintingConfirmedByClient: true, isDeliveryConfirmedByClient: true },
    { id: 'PRJ003', projectName: 'Lamaran Citra Lestari', clientName: 'Citra Lestari', clientId: 'CLI003', projectType: 'Lamaran', packageName: MOCK_PACKAGES[3].name, packageId: 'PKG004', addOns: [], date: createMockDate(-2, 20), deadlineDate: createMockDate(-1, 20), location: 'Bandung', progress: 100, status: 'Selesai', totalCost: 5000000, amountPaid: 0, paymentStatus: PaymentStatus.BELUM_BAYAR, team: [{ memberId: 'TM001', name: 'Bambang Sudiro', role: 'Fotografer', fee: 1500000, reward: 150000 }], finalDriveLink: 'https://example.com/final-citra' },
    { 
        id: 'PRJ004', 
        projectName: 'Pernikahan Fajar', 
        clientName: 'Fajar Nugraha', 
        clientId: 'CLI004', 
        projectType: 'Pernikahan', 
        packageName: MOCK_PACKAGES[0].name, 
        packageId: 'PKG001', 
        addOns: [MOCK_ADDONS[3]], 
        date: createMockDate(0, 28), 
        deadlineDate: createMockDate(1, 28), 
        location: 'Gedung Kesenian, Jakarta', 
        progress: 70, 
        status: 'Editing', 
        activeSubStatuses: ['Editing Video'], 
        totalCost: 13000000, 
        amountPaid: 0, 
        paymentStatus: PaymentStatus.BELUM_BAYAR, 
        team: [{ memberId: 'TM005', name: 'Agung Perkasa', role: 'Videografer', fee: 2000000, reward: 200000 }, { memberId: 'TM004', name: 'Dewi Anjani', role: 'Editor', fee: 1000000, reward: 100000 }],
    ...
    { id: 'PRJ005', projectName: 'Pernikahan Eko & Pasangan', clientName: 'Eko Prasetyo', clientId: 'CLI005', projectType: 'Pernikahan', packageName: MOCK_PACKAGES[2].name, packageId: 'PKG003', addOns: [], date: createMockDate(2, 15), deadlineDate: createMockDate(3, 15), location: 'Surabaya', progress: 0, status: 'Tertunda', activeSubStatuses: ['Menunggu DP'], totalCost: 28000000, amountPaid: 0, paymentStatus: PaymentStatus.BELUM_BAYAR, team: [] },
    { id: 'PRJ006', projectName: 'Prewedding Gita Permata', clientName: 'Gita Permata', clientId: 'CLI006', projectType: 'Pre-wedding', packageName: MOCK_PACKAGES[4].name, packageId: 'PKG005', addOns: [], date: createMockDate(-1, 10), deadlineDate: createMockDate(0, 1), location: 'Kawah Putih, Bandung', progress: 80, status: 'Revisi', activeSubStatuses: ['Revisi Klien 1'], totalCost: 7500000, amountPaid: 0, paymentStatus: PaymentStatus.BELUM_BAYAR, team: [{ memberId: 'TM001', name: 'Bambang Sudiro', role: 'Fotografer', fee: 1750000, reward: 200000 }, { memberId: 'TM003', name: 'Rahmat Hidayat', role: 'Videografer', fee: 2000000, reward: 200000 }], revisions: [{id: 'REV001', date: createMockDate(0, -3), adminNotes: 'Tolong perbaiki tone warna di menit 2:15-2:30, buat lebih warm.', deadline: createMockDate(0, 4), freelancerId: 'TM003', status: RevisionStatus.PENDING,}] },
    { id: 'PRJ007', projectName: 'Event EO Hendra', clientName: 'Hendra Wijaya (EO)', clientId: 'CLI007', projectType: 'Acara Korporat', packageName: MOCK_PACKAGES[0].name, packageId: 'PKG001', addOns: [MOCK_ADDONS[0], MOCK_ADDONS[1]], date: createMockDate(0, 15), deadlineDate: createMockDate(1, 15), location: 'Ritz-Carlton, Surabaya', progress: 40, status: 'Dikonfirmasi', activeSubStatuses: ['DP Lunas', 'Kontrak Ditandatangani'], totalCost: 17500000, amountPaid: 0, paymentStatus: PaymentStatus.BELUM_BAYAR, team: [{ memberId: 'TM001', name: 'Bambang Sudiro', role: 'Fotografer', fee: 1500000, reward: 300000}, { memberId: 'TM005', name: 'Agung Perkasa', role: 'Videografer', fee: 2000000, reward: 400000}] },
    { id: 'PRJ008', projectName: 'Pernikahan Lanjutan Andi', clientName: 'Andi & Siska', clientId: 'CLI001', projectType: 'Pernikahan', packageName: MOCK_PACKAGES[2].name, packageId: 'PKG003', addOns: [], date: createMockDate(3, 20), deadlineDate: createMockDate(4, 20), location: 'Bali', progress: 10, status: 'Persiapan', activeSubStatuses: ['Survey Lokasi'], totalCost: 28000000, amountPaid: 0, paymentStatus: PaymentStatus.BELUM_BAYAR, team: [] },
    { id: 'PRJ009', projectName: 'Ulang Tahun Anak Fajar', clientName: 'Fajar Nugraha', clientId: 'CLI004', projectType: 'Ulang Tahun', packageName: MOCK_PACKAGES[3].name, packageId: 'PKG004', addOns: [], date: createMockDate(0, 22), deadlineDate: createMockDate(1, 22), location: 'Rumah Fajar, Jakarta', progress: 85, status: 'Cetak', activeSubStatuses: ['Layouting Album'], totalCost: 5000000, amountPaid: 0, paymentStatus: PaymentStatus.BELUM_BAYAR, team: [{memberId: 'TM002', name: 'Siti Aminah', role: 'Fotografer', fee: 1500000, reward: 100000}] },
    { id: 'PRJ010', projectName: 'Revisi Video Citra', clientName: 'Citra Lestari', clientId: 'CLI003', projectType: 'Lamaran', packageName: MOCK_PACKAGES[3].name, packageId: 'PKG004', addOns: [], date: createMockDate(0, 5), deadlineDate: createMockDate(1, 5), location: 'Bandung', progress: 80, status: 'Revisi', activeSubStatuses: ['Revisi Internal'], totalCost: 0, amountPaid: 0, paymentStatus: PaymentStatus.LUNAS, team: [{ memberId: 'TM004', name: 'Dewi Anjani', role: 'Editor', fee: 500000, reward: 50000}] },
    { id: 'PRJ011', projectName: 'Finalisasi Album Gita', clientName: 'Gita Permata', clientId: 'CLI006', projectType: 'Pre-wedding', packageName: MOCK_PACKAGES[4].name, packageId: 'PKG005', addOns: [MOCK_ADDONS[2]], date: createMockDate(0, 8), deadlineDate: createMockDate(1, 8), location: 'Bandung', progress: 95, status: 'Dikirim', activeSubStatuses: ['Dalam Pengiriman'], shippingDetails: 'JNE CGK123456789', totalCost: 8250000, amountPaid: 0, paymentStatus: PaymentStatus.BELUM_BAYAR, team: []},
    { id: 'PRJ012', projectName: 'Foto Produk Kopi Hendra', clientName: 'Hendra Wijaya (EO)', clientId: 'CLI007', projectType: 'Acara Korporat', packageName: MOCK_PACKAGES[3].name, packageId: 'PKG004', addOns: [], date: createMockDate(0, 1), deadlineDate: createMockDate(0, 15), location: 'Studio, Surabaya', progress: 75, status: 'Editing', activeSubStatuses: ['Editing Foto', 'Seleksi Foto'], totalCost: 5000000, amountPaid: 0, paymentStatus: PaymentStatus.BELUM_BAYAR, team: [{ memberId: 'TM001', name: 'Bambang Sudiro', role: 'Fotografer', fee: 1000000, reward: 100000}] },
];
...
const baseTransactions: Transaction[] = [
    ...
    { id: 'TRN-TFR-001', date: createMockDate(-5, 5), description: 'Setor ke Dana Darurat', amount: 10000000, type: TransactionType.EXPENSE, category: 'Transfer Internal', method: 'Sistem', cardId: 'CARD001', pocketId: 'POC001' },
    { id: 'TRN-TFR-002', date: createMockDate(-5, 6), description: 'Setor ke Beli Kamera Baru', amount: 8000000, type: TransactionType.EXPENSE, category: 'Transfer Internal', method: 'Sistem', cardId: 'CARD001', pocketId: 'POC002' },
    ...
    { id: 'TRN-PRJ002-DP', date: createMockDate(-3, 20), description: 'DP Proyek Prewedding Budi', amount: 6000000, type: TransactionType.INCOME, projectId: 'PRJ002', category: 'DP Proyek', method: 'Transfer Bank', cardId: 'CARD001' },
    { id: 'TRN-PRJ002-FINAL', date: createMockDate(-2, 25), description: 'Pelunasan Proyek Prewedding Budi', amount: 6000000, type: TransactionType.INCOME, projectId: 'PRJ002', category: 'Pelunasan Proyek', method: 'Transfer Bank', cardId: 'CARD002' },
    { id: 'TRN-PRJ002-FEE', date: createMockDate(-2, 26), description: 'Gaji Freelancer Siti Aminah - Proyek Budi', amount: 2000000, type: TransactionType.EXPENSE, projectId: 'PRJ002', category: 'Gaji Freelancer', method: 'Transfer Bank', cardId: 'CARD001' },
    { id: 'TRN-PRJ002-RWD', date: createMockDate(-2, 26), description: 'Hadiah untuk Siti Aminah (Proyek: Prewedding Budi & Rekan)', amount: 250000, type: TransactionType.EXPENSE, category: 'Hadiah Freelancer', method: 'Sistem' },
    { id: 'TRN-PRJ002-COST', date: createMockDate(-3, 23), description: 'Transportasi & Akomodasi Bromo', amount: 2500000, type: TransactionType.EXPENSE, projectId: 'PRJ002', category: 'Transportasi', method: 'Tunai', cardId: 'CARD_CASH' },
    // Project 3 (Citra) - Selesai
    { id: 'TRN-PRJ003-FULL', date: createMockDate(-2, 18), description: 'Pelunasan Proyek Lamaran Citra', amount: 5000000, type: TransactionType.INCOME, projectId: 'PRJ003', category: 'Pelunasan Proyek', method: 'Transfer Bank', cardId: 'CARD001' },
    { id: 'TRN-PRJ003-FEE', date: createMockDate(-2, 19), description: 'Gaji Freelancer Bambang Sudiro - Proyek Citra', amount: 1500000, type: TransactionType.EXPENSE, projectId: 'PRJ003', category: 'Gaji Freelancer', method: 'Transfer Bank', cardId: 'CARD001' },
    { id: 'TRN-PRJ003-RWD', date: createMockDate(-2, 19), description: 'Hadiah untuk Bambang Sudiro (Proyek: Lamaran Citra Lestari)', amount: 150000, type: TransactionType.EXPENSE, category: 'Hadiah Freelancer', method: 'Sistem' },
    // Project 1 (Andi) - Persiapan
    { id: 'TRN-PRJ001-DP', date: createMockDate(0, -10), description: 'DP Proyek Pernikahan Andi & Siska', amount: 10000000, type: TransactionType.INCOME, projectId: 'PRJ001', category: 'DP Proyek', method: 'Transfer Bank', cardId: 'CARD002' },
    // Project 4 (Fajar) - Editing
    { id: 'TRN-PRJ004-DP', date: createMockDate(0, -5), description: 'DP Proyek Pernikahan Fajar', amount: 6500000, type: TransactionType.INCOME, projectId: 'PRJ004', category: 'DP Proyek', method: 'Transfer Bank', cardId: 'CARD001' },
    { id: 'TRN-PRJ004-RWD', date: createMockDate(0, -5), description: 'Hadiah untuk Agung Perkasa (Proyek: Pernikahan Fajar)', amount: 200000, type: TransactionType.EXPENSE, category: 'Hadiah Freelancer', method: 'Sistem'},
    { id: 'TRN-PRJ004-RWD2', date: createMockDate(0, -5), description: 'Hadiah untuk Dewi Anjani (Proyek: Pernikahan Fajar)', amount: 100000, type: TransactionType.EXPENSE, category: 'Hadiah Freelancer', method: 'Sistem'},
    // Project 6 (Gita) - Revisi
    { id: 'TRN-PRJ006-FULL', date: createMockDate(-1, 8), description: 'Pelunasan Proyek Prewedding Gita', amount: 7500000, type: TransactionType.INCOME, projectId: 'PRJ006', category: 'Pelunasan Proyek', method: 'Transfer Bank', cardId: 'CARD001' },
    { id: 'TRN-PRJ006-FEE1', date: createMockDate(-1, 9), description: 'Gaji Freelancer Bambang Sudiro - Proyek Gita', amount: 1750000, type: TransactionType.EXPENSE, projectId: 'PRJ006', category: 'Gaji Freelancer', method: 'Transfer Bank', cardId: 'CARD001' },
    { id: 'TRN-PRJ006-FEE2', date: createMockDate(-1, 9), description: 'Gaji Freelancer Rahmat Hidayat - Proyek Gita', amount: 2000000, type: TransactionType.EXPENSE, projectId: 'PRJ006', category: 'Gaji Freelancer', method: 'Transfer Bank', cardId: 'CARD001' },
    { id: 'TRN-PRJ006-RWD1', date: createMockDate(-1, 9), description: 'Hadiah untuk Bambang Sudiro (Proyek: Prewedding Gita Permata)', amount: 200000, type: TransactionType.EXPENSE, category: 'Hadiah Freelancer', method: 'Sistem'},
    { id: 'TRN-PRJ006-RWD2', date: createMockDate(-1, 9), description: 'Hadiah untuk Rahmat Hidayat (Proyek: Prewedding Gita Permata)', amount: 200000, type: TransactionType.EXPENSE, category: 'Hadiah Freelancer', method: 'Sistem'},
    // Project 7 (Hendra) - Dikonfirmasi
    { id: 'TRN-PRJ007-DP', date: createMockDate(0, -2), description: 'DP Proyek Event EO Hendra', amount: 8000000, type: TransactionType.INCOME, projectId: 'PRJ007', category: 'DP Proyek', method: 'Transfer Bank', cardId: 'CARD001' },
    // Project 9 (Fajar Birthday) - Cetak
    { id: 'TRN-PRJ009-FULL', date: createMockDate(0, 20), description: 'Pelunasan Proyek Ulang Tahun Anak Fajar', amount: 5000000, type: TransactionType.INCOME, projectId: 'PRJ009', category: 'Pelunasan Proyek', method: 'Tunai', cardId: 'CARD_CASH'},
    // Project 11 (Gita Album) - Dikirim
    { id: 'TRN-PRJ011-FULL', date: createMockDate(0, 6), description: 'Pelunasan Proyek Finalisasi Album Gita', amount: 8250000, type: TransactionType.INCOME, projectId: 'PRJ011', category: 'Pelunasan Proyek', method: 'Transfer Bank', cardId: 'CARD002'},
    { id: 'TRN-PRJ011-PRINT', date: createMockDate(0, 7), description: 'Biaya Cetak Kanvas - Gita', amount: 750000, type: TransactionType.EXPENSE, projectId: 'PRJ011', category: 'Cetak Foto', method: 'Transfer Bank', cardId: 'CARD001'},
    // Project 12 (Hendra Kopi) - Editing
    { id: 'TRN-PRJ012-DP', date: createMockDate(0, 0), description: 'DP Proyek Foto Produk Kopi Hendra', amount: 2500000, type: TransactionType.INCOME, projectId: 'PRJ012', category: 'DP Proyek', method: 'Transfer Bank', cardId: 'CARD001' },
    // General & Internal
    { id: 'TRN-GEN-001', date: createMockDate(0, -15), description: 'Biaya Iklan Instagram', amount: 750000, type: TransactionType.EXPENSE, category: 'Marketing', method: 'Kartu', cardId: 'CARD003' },
    { id: 'TRN-GEN-002', date: createMockDate(0, -10), description: 'Pembelian ATK Kantor', amount: 500000, type: TransactionType.EXPENSE, category: 'Operasional Kantor', method: 'Sistem', pocketId: 'POC003' },
    { id: 'TRN-RWD-WTH-BAMBANG', date: createMockDate(0, -5), description: 'Penarikan saldo hadiah oleh Bambang Sudiro', amount: 350000, type: TransactionType.EXPENSE, category: 'Penarikan Hadiah Freelancer', method: 'Transfer Bank', cardId: 'CARD001' },
];
...
export const MOCK_REWARD_LEDGER_ENTRIES: RewardLedgerEntry[] = baseTransactions
    ...
    .map(t => {
        ...
        return {
            id: `RLE-${t.id}`, teamMemberId: memberId, date: t.date, description: t.description,
            amount: t.category === 'Penarikan Hadiah Freelancer' ? -t.amount : t.amount,
        };
    }).filter(e => e.teamMemberId).sort((a,b) => new Date(b.date).getTime() - new Date(a.date).getTime());
...
let cardsData: Card[] = [
  { id: 'CARD001', cardHolderName: 'Admin Vena', bankName: 'WBank', cardType: CardType.PRABAYAR, lastFourDigits: '3090', expiryDate: '09/24', balance: 0, colorGradient: 'from-purple-500 to-indigo-600' },
  { id: 'CARD002', cardHolderName: 'Admin Vena', bankName: 'WBank', cardType: CardType.PRABAYAR, lastFourDigits: '9800', expiryDate: '04/26', balance: 0, colorGradient: 'from-blue-500 to-cyan-500' },
  { id: 'CARD003', cardHolderName: 'Admin Vena', bankName: 'VISA', cardType: CardType.KREDIT, lastFourDigits: '0032', expiryDate: '09/24', balance: 0, colorGradient: 'from-slate-100 to-slate-300' },
...
export const MOCK_TEAM_PAYMENT_RECORDS: TeamPaymentRecord[] = [
    { id: 'TPR001', recordNumber: 'PAY-FR-TM002-1234', teamMemberId: 'TM002', date: createMockDate(-2, 26), projectPaymentIds: ['TPP-PRJ002-TM002'], totalAmount: 2000000 },
    { id: 'TPR002', recordNumber: 'PAY-FR-TM001-5678', teamMemberId: 'TM001', date: createMockDate(-2, 19), projectPaymentIds: ['TPP-PRJ003-TM001'], totalAmount: 1500000 },
    { id: 'TPR003', recordNumber: 'PAY-FR-TM001-9012', teamMemberId: 'TM001', date: createMockDate(-1, 9), projectPaymentIds: ['TPP-PRJ006-TM001'], totalAmount: 1750000 },
    { id: 'TPR004', recordNumber: 'PAY-FR-TM003-3456', teamMemberId: 'TM003', date: createMockDate(-1, 9), projectPaymentIds: ['TPP-PRJ006-TM003'], totalAmount: 2000000 },
];
...
export const MOCK_ASSETS: Asset[] = [
    ...
    { id: 'ASSET002', name: 'Sony FE 24-70mm f/2.8 GM II', category: 'Lensa', purchaseDate: createMockDate(-12, 5), purchasePrice: 32000000, serialNumber: 'SN98765432', status: AssetStatus.IN_USE, notes: 'Digunakan oleh Bambang' },
    { id: 'ASSET003', name: 'DJI Mavic 3 Pro', category: 'Drone', purchaseDate: createMockDate(-6, 15), purchasePrice: 30000000, serialNumber: 'SNDRONE01', status: AssetStatus.AVAILABLE },
    { id: 'ASSET004', name: 'Godox AD200 Pro', category: 'Lighting', purchaseDate: createMockDate(-24, 1), purchasePrice: 5000000, status: AssetStatus.MAINTENANCE, notes: 'Bohlam perlu diganti.' },
    { id: 'ASSET005', name: 'Canon EOS R5', category: 'Kamera', purchaseDate: createMockDate(-3, 20), purchasePrice: 60000000, serialNumber: 'SNCANONR5', status: AssetStatus.IN_USE, notes: 'Digunakan oleh Siti Aminah' },
];

export const MOCK_CONTRACTS: Contract[] = [
    { id: 'CTR001', contractNumber: 'VP/CTR/2024/001', clientId: 'CLI001', projectId: 'PRJ001', signingDate: createMockDate(0, -15), signingLocation: 'Kantor Vena Pictures', createdAt: createMockDate(0, -15), clientName1: 'Andi', clientAddress1: 'Hotel Mulia, Jakarta', clientPhone1: '081111111111', clientName2: 'Siska', clientAddress2: 'Hotel Mulia, Jakarta', clientPhone2: '081111111111', shootingDuration: 'Sesuai detail paket', guaranteedPhotos: '400 Foto Edit', albumDetails: '1 Album (20x30 cm, 20 halaman, Box), Cetak 4R (20 lembar + Box)', digitalFilesFormat: 'Semua File (USB)', otherItems: 'Sewa Drone', personnelCount: '2 Fotografer, 2 Videografer', deliveryTimeframe: '45 hari kerja', dpDate: createMockDate(0, -15), finalPaymentDate: createMockDate(1, 3), cancellationPolicy: 'DP yang sudah dibayarkan tidak dapat dikembalikan.\nJika pembatalan dilakukan H-7 sebelum hari pelaksanaan, PIHAK KEDUA wajib membayar 50% dari total biaya.', jurisdiction: 'Jakarta' },
    { id: 'CTR002', contractNumber: 'VP/CTR/2024/002', clientId: 'CLI004', projectId: 'PRJ004', signingDate: createMockDate(0, -6), signingLocation: 'Online', createdAt: createMockDate(0, -6), clientName1: 'Fajar Nugraha', clientAddress1: 'Gedung Kesenian, Jakarta', clientPhone1: '084444444444', clientName2: '', clientAddress2: '', clientPhone2: '', shootingDuration: 'Sesuai detail paket', guaranteedPhotos: '300 Foto Edit', albumDetails: '1 Album (20x30 cm, 20 halaman)', digitalFilesFormat: 'Semua File (Link Drive)', otherItems: 'Jam Liputan Tambahan', personnelCount: '2 Fotografer, 1 Videografer', deliveryTimeframe: '30 hari kerja', dpDate: createMockDate(0, -6), finalPaymentDate: createMockDate(0, 21), cancellationPolicy: 'DP tidak dapat dikembalikan.', jurisdiction: 'Jakarta' },
];

export const MOCK_CLIENT_FEEDBACK: ClientFeedback[] = [
    { id: 'FB001', clientName: 'Budi Santoso', satisfaction: SatisfactionLevel.VERY_SATISFIED, rating: 5, feedback: 'Tim sangat profesional dan hasilnya luar biasa! Sangat puas dengan pelayanan Vena Pictures.', date: createMockDate(-1, 28) },
    { id: 'FB002', clientName: 'Citra Lestari', satisfaction: SatisfactionLevel.SATISFIED, rating: 4, feedback: 'Secara keseluruhan bagus, komunikasinya lancar. Hasilnya juga memuaskan.', date: createMockDate(0, -5) },
    { id: 'FB003', clientName: 'Fajar Nugraha', satisfaction: SatisfactionLevel.NEUTRAL, rating: 3, feedback: 'Hasilnya oke, tapi proses editing agak lama dari yang diharapkan.', date: createMockDate(0, -1) },
];

export const MOCK_NOTIFICATIONS: Notification[] = [
    { id: 'NOTIF001', title: 'Revisi Tertunda', message: 'Rahmat Hidayat belum menyelesaikan revisi untuk proyek "Prewedding Gita Permata".', timestamp: new Date(new Date().setDate(new Date().getDate() - 1)).toISOString(), isRead: false, icon: 'revision', link: { view: ViewType.PROJECTS, action: { type: 'VIEW_PROJECT_DETAILS', id: 'PRJ006' }}},
    { id: 'NOTIF002', title: 'Deadline Mendekat', message: 'Proyek "Event EO Hendra" akan segera mencapai deadline.', timestamp: new Date(new Date().setDate(new Date().getDate() - 2)).toISOString(), isRead: false, icon: 'deadline', link: { view: ViewType.PROJECTS, action: { type: 'VIEW_PROJECT_DETAILS', id: 'PRJ007' }}},
    { id: 'NOTIF003', title: 'Prospek Baru Masuk', message: 'Maya Putri dari Referral, lokasi di Bandung.', timestamp: new Date(new Date().setDate(new Date().getDate() - 0)).toISOString(), isRead: false, icon: 'lead', link: { view: ViewType.PROSPEK, action: { type: 'VIEW_LEAD', id: 'LEAD008' }}},
    { id: 'NOTIF004', title: 'Pembayaran Belum Lunas', message: 'Pelunasan untuk proyek "Pernikahan Andi & Siska" belum diterima.', timestamp: new Date(new Date().setDate(new Date().getDate() - 4)).toISOString(), isRead: true, icon: 'payment', link: { view: ViewType.CLIENTS, action: { type: 'VIEW_CLIENT_DETAILS', id: 'CLI001' }}},
    { id: 'NOTIF005', title: 'Proyek Selesai', message: 'Proyek "Lamaran Citra Lestari" telah selesai. Minta feedback klien.', timestamp: new Date(new Date().setDate(new Date().getDate() - 6)).toISOString(), isRead: true, icon: 'completed', link: { view: ViewType.CLIENTS, action: { type: 'VIEW_CLIENT_DETAILS', id: 'CLI003' }}},
];

export const MOCK_SOCIAL_MEDIA_POSTS: SocialMediaPost[] = [
    { id: 'SMP001', projectId: 'PRJ001', clientName: 'Andi & Siska', postType: PostType.INSTAGRAM_REELS, platform: 'Instagram', scheduledDate: createMockDate(0, 7), caption: 'Momen magis dari pernikahan Andi & Siska! ✨ #weddingreels #venapictures', mediaUrl: 'https://example.com/reels/andi_siska.mp4', status: PostStatus.SCHEDULED, notes: 'Gunakan lagu "Perfect - Ed Sheeran".' },
    { id: 'SMP002', projectId: 'PRJ002', clientName: 'Budi Santoso (WO)', postType: PostType.INSTAGRAM_FEED, platform: 'Instagram', scheduledDate: createMockDate(-1, 0), caption: 'Menjelajahi keindahan Bromo bersama Budi & Rekan. 🌄 #preweddingbromo #venapictures', mediaUrl: 'https://example.com/feed/budi_bromo.jpg', status: PostStatus.POSTED },
    { id: 'SMP003', projectId: 'PRJ003', clientName: 'Citra Lestari', postType: PostType.INSTAGRAM_STORY, platform: 'Instagram', scheduledDate: createMockDate(0, 1), caption: 'Behind the scenes lamaran Citra!', status: PostStatus.SCHEDULED, notes: 'Buat polling "Tim lamaran siapa nih?".' },
    { id: 'SMP004', projectId: 'PRJ004', clientName: 'Fajar Nugraha', postType: PostType.TIKTOK, platform: 'TikTok', scheduledDate: createMockDate(0, 10), caption: 'GRWM versi vendor! #weddingvendor #behindthescenes', status: PostStatus.DRAFT },
    { id: 'SMP005', projectId: 'PRJ006', clientName: 'Gita Permata', postType: PostType.BLOG, platform: 'Website', scheduledDate: createMockDate(0, 12), caption: '5 Tips Pre-wedding di Kawah Putih: Panduan Lengkap', status: PostStatus.DRAFT },
    { id: 'SMP006', projectId: 'PRJ009', clientName: 'Fajar Nugraha', postType: PostType.INSTAGRAM_FEED, platform: 'Instagram', scheduledDate: createMockDate(0, 25), caption: 'Happy birthday! 🎂 Serunya pesta ulang tahun anak Fajar.', status: PostStatus.DRAFT },
];
